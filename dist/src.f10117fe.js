...
var CollectionView = /*#__PURE__*/function () {
  ...
  _createClass(CollectionView, [{
    ...
    value: function render() {
      ...
      var tempalteElement = document.createElement('template');
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    ...
    value: function render() {
      ...
      this.parent.innerHTML = ''; //CREATE ELEMENT / WRITE HTML TO ELEMENT

      var templateElement = document.createElement('template');
      templateElement.innerHTML = this.template(); //BIND EVENT AND LISTENERS TO PARENT ELEMENT
      //CONTENT = REFERENCE TO HTML DOCUMENT FRAGMENT

      this.bindEvents(templateElement.content); //CONNECT DATA MAPPER TO RENDER DISPLAY REGIONS?

      this.mapRegions(templateElement.content); //ESTABLISH DOUCMENT TREE

      this.onRender(); //INSERT FRAGEMENT INTO DOM UNDER PARENT
...
},{"../views/CollectionView":"src/views/CollectionView.ts","../views/UserShow":"src/views/UserShow.ts"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{}],"../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/node_modules/isarray/index.js":[function(require,module,exports) {
...
},{}],"../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js","ieee754":"../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js","isarray":"../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/node_modules/isarray/index.js","buffer":"../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/axios/lib/helpers/toFormData.js":[function(require,module,exports) {
...
},{"../utils":"node_modules/axios/lib/utils.js","buffer":"../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/axios/lib/core/settle.js":[function(require,module,exports) {
'use strict';
...
},{}],"../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
function () {
  function Eventing() {
    ...
    this.events = {}; //EVENT SUBSCRIBER - ADD CALLBACKS TO ARRAY FOR EACH ACTION/EVENT
...
exports.Attributes = Attributes; // const attributes = new Attributes<UserProps>({ id: 5, name: 'person', age: 21 })
...
function (_super) {
  ...
  User.buildUser = function (attributes) {
    return new User(new Attributes_1.Attributes(attributes), new Eventing_1.Eventing(), new APISync_1.APISync(rootURL));
  };
...
var UserForm = /*#__PURE__*/function (_View_1$View) {
  ...
  function UserForm() {
    ...
    _this.onSetNameClick = function () {
      var input = _this.parent.querySelector('input'); //CHECK AGAINST NULL VALUE
...
var UserEdit_1 = require("./views/UserEdit"); // const user = User.buildUser({ name: 'Bozo', age: 23 });
...
users.fetch(); // const url = 'http://localhost:3000/users'
...
// user.trigger('change')
// user.trigger('save')
},{"./views/UserList":"src/views/UserList.ts","./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts","./views/UserEdit":"src/views/UserEdit.ts"}],"../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../.nvm/versions/node/v14.19.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
